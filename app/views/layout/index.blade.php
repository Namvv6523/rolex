                        ...
                        <ul id="iq-sidebar-toggle" class="iq-menu">
                            ...
                            <li class=" ">
                                ...
                                <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li class="">
                                        <a href="{{BASE_URL}}category/list">
                                            <i class="las la-minus"></i><span>Danh sách danh mục</span>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="{{BASE_URL}}category/store">
                                ...
                                <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li class=" ">
                                        ...
                                        <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                            <li class="">
                                                <a
                                                    href="http://iqonic.design/themes/posdash/html/app/user-profile.html">
                          ...
                          <div class="custom-control custom-switch custom-switch-icon custom-control-inline">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                    ...
                                    <li class="nav-item nav-icon dropdown">
                                        <a href="index.html#" class="search-toggle dropdown-toggle"
                                                ...
                                                <div class="card-body p-0 text-center">
                                                    ...
                                                    <div class="p-3">
                                                        <h5 class="mb-1"><a
                                                                ...
                                                                class="__cf_email__"
                                                                data-cfemail="e7ad888689a39288a7979588978295939ec984888a">[email&#160;protected]</a>
                                                        </h5>
